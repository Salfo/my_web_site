...
Being an economist from one of the CFA zone countries (Burkina Faso), I have decided to join the fight of a generation by lending my analytics skills to the anti-France discussion. Hopefully, no argument can beat powerful facts. So, let’s get the facts on whether the CFA zone is the least developed part of Africa, and whether the CFA is the culprit.  
