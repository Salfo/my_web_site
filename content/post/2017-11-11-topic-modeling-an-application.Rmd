...
After pre-processing the data, I am left with a dataset of 596 observations and 1034 words (or variables). You can take a look at the pre-processed data <a href="http://rpubs.com/sbikienga/334137" target="_blank">here</a>, or you can download it <a href="https://github.com/Salfo/States-Addresses/raw/master/data/SoSA_data_df.RData" target="_blank">here</a>. 
...
$\theta$ alone, or combined with other control variables, $X$, can be used for regular statistical analysis. $\theta$ is just additional control variables. It has been used for economic analyses.
...
In sum, topic modeling in general and LDA in particular is a dimension reduction method. It consists of collapsing a matrix of words counts into a reduced matrix of topics distributions. Hopefully this illustration provides a sense of its usefulness for statistcal analysis. 
